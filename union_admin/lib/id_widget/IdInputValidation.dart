              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: (widget.enabledBorderColor != null)
                      ? OutlineInputBorder(
                          borderSide:
                              BorderSide(color: (widget.validationVisible) ? IdColors.black : const Color.fromRGBO(0, 0, 0, 0), width: 1.0),
                          borderRadius: BorderRadius.circular(widget.round),
                        )
                      : null,
                  //엑티브 됐을때
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  uiCommon.styledText(widget.validationText, 14, 0, 1.6, FontWeight.w400, IdColors.black, TextAlign.left),
                ],
              ),
            ],
          ),
