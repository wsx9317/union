...
class IdLotInfoInpuTable3 extends StatefulWidget {
  ...
  @override
  State<IdLotInfoInpuTable3> createState() => _IdLotInfoInpuTable3State();
}

class _IdLotInfoInpuTable3State extends State<IdLotInfoInpuTable3> {
  List tableBodyList = [];
