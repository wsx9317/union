...
enum CalendarDatePicker2View { none, first, last }
...
class CalendarDatePicker2Config {
  CalendarDatePicker2Config({
    ...
    CalendarDatePicker2View? calendarView,
    DateTime? firstDate,
    DateTime? lastDate,
    ...
    this.modePickerTextHandler,
        ...
        calendarView = calendarView ?? CalendarDatePicker2View.none,
  ...
  /// The enabled date picker view for first or last date
  CalendarDatePicker2View calendarView;
