...
class _KakaoAddressWidgetState extends State<KakaoAddressWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      final jsUtil = JsUtil();
      await jsUtil.importUrl(url: '//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js');

      try {
        js.setProperty(js.globalThis, 'onSelectAddress', js.allowInterop(onComplete));
      } catch (e) {}
      const jsCode = r'''
