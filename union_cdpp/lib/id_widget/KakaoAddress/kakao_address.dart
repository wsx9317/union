...
class KakaoAddress {
  ...
  factory KakaoAddress.fromJson(Map json) {
    var ret = KakaoAddress(
    ...
    print( json[Constants.sigunguCode] as String);
    print('--------');
    print(ret);
  ...
  @override
  String toString() {
    return 'KakaoAddress(postCode: $postCode, address: $address, addressEng: $addressEng, roadAddress: $roadAddress, roadAddressEng: $roadAddressEng, jibunAddress: $jibunAddress, jibunAddressEng: $jibunAddressEng, buildingCode: $buildingCode, buildingName: $buildingName, apartment: $apartment, addressType: $addressType, sido: $sido, sidoEng: $sidoEng, sigungu: $sigungu, sigunguEng: $sigunguEng, sigunguCode: $sigunguCode, roadnameCode: $roadnameCode, bcode: $bcode, roadname: $roadname, roadnameEng: $roadnameEng, bname: $bname, bnameEng: $bnameEng, bname1: $bname1, query: $query, userSelectedType: $userSelectedType, userLanguageType: $userLanguageType)';
  }
}
