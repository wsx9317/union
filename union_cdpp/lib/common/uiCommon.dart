...
import 'package:unionCDPP/common/jpeg_encode.dart';
...
mixin uiCommon {
  ...
  static bool _isNeededForceQuit(String m1) {
    if (m1 == PAGE_INTRO ||
        m1 == PAGE_INTRO2 ||
        m1 == PAGE_INTRO3 ||
        m1 == PAGE_LOGGED_INTRO ||
        m1 == PAGE_LOGGED_INTRO2 ||
        m1 == PAGE_LOGGED_INTRO3 ||
        m1 == PAGE_LOGIN ||
        m1 == PAGE_SIGNUP ||
        m1 == PAGE_FIND_IDPWD) return true;
    return false;
  }

  static bool _isPopupWindow(String m1) {
    if (m1 == PAGE_CERT_PDF_PAGE || m1 == PAGE_TM_PDF_PAGE) return true;
    return false;
  }

  static Future<bool> IdMovePage(BuildContext context, String toGomenu, {String? param}) async {
    ...
    uiCommon.IdPushPage(context, toGomenu);
    await Navigator.pushReplacementNamed(context, '/$toGomenu');
    return true;
  }

  static void IdPushPage(BuildContext context, String menu) {
  ...
  static Widget styledText(
    ...
    return StyledText(
      ...
      tags: {
        ...
        'name2': StyledTextTag(style: TextStyle(color: IdColors.green2, fontWeight: FontWeight.w500)),
